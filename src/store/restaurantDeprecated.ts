...
// import type { BankSettings, BasicInfo, ContactInfo, Restaurant, Schedule, Settings } from '@/interfaces/restaurant.interface';
...
//       this.restaurant.settings.logo = logo?.data as string;
//       return logo;
//     },
